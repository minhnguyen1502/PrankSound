package funnysoundapp.fartpranksound.creepysound.hairclippersound.friendsprankapp.util;
...
public class SharePrefUtils {
    public static String email = "sanshin.phamngocan@gmail.com";
    public static String subject = "Prank Sound";
