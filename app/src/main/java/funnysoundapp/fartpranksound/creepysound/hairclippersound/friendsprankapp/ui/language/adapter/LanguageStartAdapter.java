package funnysoundapp.fartpranksound.creepysound.hairclippersound.friendsprankapp.ui.language.adapter;
...
import funnysoundapp.fartpranksound.creepysound.hairclippersound.friendsprankapp.ui.language.interfaces.IClickLanguage;
...
public class  LanguageStartAdapter extends RecyclerView.Adapter<LanguageStartAdapter.LanguageViewHolder> {
    ...
    public static class LanguageViewHolder extends RecyclerView.ViewHolder {
        ...
        public LanguageViewHolder(@NonNull View itemView) {
            ...
            layoutItem = itemView.findViewById(R.id.item);
        }
    }
